  ...
  return (
    <aside className="w-64 bg-slate-900/95 border-l border-slate-800 flex flex-col justify-between p-4 min-h-screen shrink-0 transition-colors duration-300">
      <div className="space-y-4">
        ...
        {/* User Info pill */}
        {user && (
          <div className="px-3 py-2 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center gap-2 text-xs">
      ...
      <div className="pt-3 border-t border-slate-800 space-y-1">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium text-slate-400 hover:text-white hover:bg-slate-800/60 transition"
        >
        ...
        <button
          type="button"
          onClick={() => logout()}
          className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-medium text-red-400 hover:bg-red-950/40 hover:text-red-300 transition text-right cursor-pointer"
        >
